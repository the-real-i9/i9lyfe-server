...
// 		ctx,
// 		/* sql */ `
// 		SELECT id_, owner_user, type_, media_urls, description, created_at, reposted_by_user, null as cursor FROM posts
// 		WHERE id_ = $1
// 		`, postId,
// 	)
// 	if err != nil {
...
// 		ctx,
// 		/* sql */ `
// 		SELECT comment_id, username AS owner_user, comment_text, attachment_url, at_, null as cursor FROM user_comments_on
// 		WHERE id_ = $1
// 		`, commentId,
// 	)
// 	if err != nil {
