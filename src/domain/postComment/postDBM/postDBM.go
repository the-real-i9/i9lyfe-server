...
func New(ctx context.Context, clientUsername string, mediaCloudNames []string, postType, description string, at int64, mentions, hashtags []string) (post UITypes.NewPost, err error) {
	newPost, err := pgDB.QueryRowType[UITypes.NewPost](
		ctx,
		/* sql */ `
...
func CommentOn(ctx context.Context, clientUsername, postId, commentText, attachmentCloudName string, at int64, mentions []string) (UITypes.NewComment, error) {
...
func Repost(ctx context.Context, clientUsername, postId string) (RepostT, error) {
